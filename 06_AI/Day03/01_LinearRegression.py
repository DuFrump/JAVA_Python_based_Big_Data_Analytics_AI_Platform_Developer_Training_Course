...
# 모델이 찾은 a와 b를 활용해서 두 점을 찍고 그래프로 그리기
# y = 39x - 709
...
# 우리의 목표 - 오차 제곱이 가장 작게 나오도록 하는 (a, b 찾기)
# (a로 정리한) 오차제곱은 아래로 볼록한 포물선
# >>> a가 몇 일때 이 포물선이 최솟값을 가질까?
# >>> 이 이차함수를 a에 대하여 미분한 값이 0이 되는, 그때의 a 값이다.
# b에 대해서도 같은 과정을 거친 뒤, 두 식을 연립 방정식 해서 a, b 값 도출!

# 길이만 가지고 하기 아쉬운 상태.
# 인위적으로 컬럼 하나를 만들어서 적용해보기.
