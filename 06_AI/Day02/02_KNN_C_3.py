...
# 중요! (!!train 평균, 표준편차로!!) 테스트 데이터도 스케일링
test_scaled = (test_input - mean) / std

print('스코어: ', kn.score(train_scaled, train_target))
print('월척 : ', kn.predict([new]))
print()
...
# 테스트 데이터
test_data = [[4, 20], [16, 126], [4, 35], [56, 204], [54, 234]]

# 테스트 데이터 정규화
new_test_data = (test_data - mean) / std

print('테스트 데이터: ', kn.predict([new_test_data]))
print()