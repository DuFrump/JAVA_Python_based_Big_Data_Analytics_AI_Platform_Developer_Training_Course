...
# titanic에서 age, fare 선택해서 df 만들기
...
print(result_df.head().round(2))
print()

# 각 열에 람다 함수 적용
result_sr = df.apply(lambda x : x.max() - x.min(), axis=0)
print(result_sr.head().round(2))
print()
